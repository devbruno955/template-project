...
<?
$textopadrao =  "O que você procura ? Ex: Apto";
?>
<div class="searchbox clearfix">
	<form class="search-slim-frm" action="/index.php?busca=true" onsubmit="return verificacampo();" >
		<fieldset>
			<div class="titencontre"><legend id="searchLabel">Encontre seu imóvel</legend></div>
...
function verificacampo(){
	...
	if(J("#querybusca").val()=="" || J("#querybusca").val() == '<?=$textopadrao?>' ){
			alert('Informe a palavra de seu interesse no campo de pesquisa. Exemplo: Apto');
			return false;
	}
}
</script>