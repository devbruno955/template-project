    ...
    <div class="main"> 
	 <?php  require_once(DIR_BLOCO."/header.php"); ?> 
		<section id="content">
            <div class="inside"> 
				<div class="col-1f"> 
					<div class="col-6" style="width:929px;margin-bottom:20px;" >
					  <div style="display:none;" class="tips"><?=__FILE__?></div>
					   <? if($_REQUEST["acao"] == "" or $_POST["acao"] == "enviadados") { ?>
						 <div class="titpages"> <?=$pagetitle?> </div>
						 <div style="float:left;margin-top:13px;width:593px;font-size:16px;">
						<div class="tail"><span style="color:303030;font-size:12px;">Divulgação de sua oferta pelo tempo que durar </span></div>
						<div class="tail"><span style="color:303030;font-size:12px;">Um canal de vendas com divulgação por toda a internet</span></div>
						<div class="tail"><span style="color:303030;font-size:12px;">Enviamos suas ofertas para milhares de e-mails de nossa base diariamente</span></div>
						<div class="tail"><span style="color:303030;font-size:12px;">Facilidade de encontrar sua oferta através dos buscadores e pesquisas como google</span></div>
						<div class="tail"><span style="color:303030;font-size:12px;">São milhares de clientes em potencial e divulgação de sua marca por todo o Brasil</span></div>
						 <br class="clear" />
						 <br class="clear" />
						 <br class="clear" />
					 ...
					 <?php if( $_REQUEST['acao'] == "proximo") { ?>
						...
						<br class="clear" />
						<h3> Preencha o formulário abaixo assim que recebermos entraremos em contato. </h3>
						<br> 
					 ...
					 <div style="font-size:16px;" class="tail"><b style="color: #4F4F4F; font-size: 20px;">Dados do seu negócio</b></div>
						...
						<table width="629" border="0"  style="color: #4F4F4F">
						  ...
						  <tr>
						   ...
						   <tr>
							<td><label for="nomeuso"></label> 
								 <select name="websites3parceiro" id="websites3parceiro" style="width:433px;  height:41px; font-size:15px; margin-left: 0px;padding:6px;">
