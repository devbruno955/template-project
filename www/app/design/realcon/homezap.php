...
<!-- Mirrored from websmirno.site/carleader/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Aug 2019 19:38:57 GMT -->
<head>
	<meta charset="utf-8">
							...
							<ul>
								<li>
						            <a href="inventory-item.html">
						            	<div class="thumbnail"><img src="<?=DIR_TEMPLATE?>/images/product/product_img_05.jpg" alt=""></div>
						        ...
						        <li>
						            <a href="inventory-item.html">
						            	<div class="thumbnail"><img src="<?=DIR_TEMPLATE?>/images/product/product_img_08.jpg" alt=""></div>
						            	<div class="tt-description">
	...
	<div class="header-holder">
		<div class="container">
			<div class="row">
				<!--logo-->
				<div class="col-logo">
					<a class="tt-logo" href="index-2.html">
						<img class="tt-logo-light svg-img" src="<?=$ROOTPATH?>/include/logo/logo.png" alt="">
						<img class="tt-logo-dark svg-img" src="<?=$ROOTPATH?>/include/logo/logo.png" alt="">
					</a>
				</div>
				...
				?>
					...
					<div class="col-menu col-auto mr-auto ">
						<div class="tt-desctop-menu" id="tt-desctop-menu">
							...
							<li >
								<a href="<?php echo $ROOTPATH."/index.php?busca=true"; ?>">
									BUSCAR VEÍCULOS
								</a>
							</li>
							<li >
								<a href="<?php echo $ROOTPATH."/index.php?busca=true&TipoVeiculo=servicos"; ?>">
									BUSCAR SERVIÇOS
								</a>
							</li>
							<li>
								...
								<ul class="sub-menu">
									...
									?>
									<li>
										<a href="<?php echo $ROOTPATH; ?>/account/">MEUS DADOS</a>				
									</li>						
									<li>
										<a href="<?php echo $ROOTPATH; ?>/adminanunciante/team">MEUS ANÚNCIOS</a>				
									</li>						
									<li>
										<a href="<?php echo $ROOTPATH; ?>/index.php?page=planos">FAZER ANÚNCIO</a>				
									</li>						
									<li>
										<a href="<?php echo $ROOTPATH; ?>/adminanunciante/team/propostas.php">PROPOSTAS</a>				
									</li>						
									<li>
										<a href="<?php echo $ROOTPATH; ?>/autenticacao/logout.php">SAIR DA CONTA</a>				
									</li>
									<?php
										} else {
									?>
									<li>
										<a href="<?php echo $ROOTPATH; ?>/auth/">ACESSAR CONTA</a>				
									</li>								
									<?php } ?>
								</ul>
							</li>						
							<li>
								<a href="<?php echo $ROOTPATH; ?>/revendas">REVENDA</a>				
							</li>						
							<li>
								<a href="<?php echo $ROOTPATH; ?>/contato">FALE CONOSCO</a>				
							</li>					
					</ul>
				...
				<div class="col-btn-toggle-modal col-auto">
					<a class="btn btn-toggle-modal" href="#"  data-toggle="modal" data-target="#modalAddYourItem"><i class="icon-addcar"></i><span class="	tt-text">ADD YOUR ITEM</span>
					</a>
				</div>
...
<div id="tt-pageContent">
	<div class="container-indent no-margin">
		<div class="mainSlider-layout">
			...
			<div class="mainSlider">
				<div class="slide">
					<div class="img--holder" data-bg="<?=DIR_TEMPLATE?>/images/slider/slide-01.jpg"></div>
				...
				<div class="slide">
					<div class="img--holder"  data-bg="<?=DIR_TEMPLATE?>/images/slider/slide-02.jpg"></div>
					<div class="slide-content">
						<div class="container" data-animation="fadeInUpSm" data-animation-delay="0s">
		...
		<div class="container-fluid">
			...
			<div class="js-carousel tt-arrow-center-fluid tt-arrow-color02 slick-alignment-arrows" data-item="5" data-dots="true">
				<a href="inventory.html" class="tt-media-02">
					<img src="<?=DIR_TEMPLATE?>/images/custom/media02-img-01.jpg" alt="">
					<div class="tt-description">
				...
				<a href="inventory.html" class="tt-media-02">
					<img src="<?=DIR_TEMPLATE?>/images/custom/media02-img-02.jpg" alt="">
					<div class="tt-description">
				...
				<a href="inventory.html" class="tt-media-02">
					<img src="<?=DIR_TEMPLATE?>/images/custom/media02-img-03.jpg" alt="">
					<div class="tt-description">
				...
				<a href="inventory.html" class="tt-media-02">
					<img src="<?=DIR_TEMPLATE?>/images/custom/media02-img-04.jpg" alt="">
					<div class="tt-description">
				...
				<a href="inventory.html" class="tt-media-02">
					<img src="<?=DIR_TEMPLATE?>/images/custom/media02-img-05.jpg" alt="">
					<div class="tt-description">
				...
				<a href="inventory.html" class="tt-media-02">
					<img src="<?=DIR_TEMPLATE?>/images/custom/media02-img-06.jpg" alt="">
					<div class="tt-description">
				...
				<a href="inventory.html" class="tt-media-02">
					<img src="<?=DIR_TEMPLATE?>/images/custom/media02-img-07.jpg" alt="">
					<div class="tt-description">
				...
				<a href="inventory.html" class="tt-media-02">
					<img src="<?=DIR_TEMPLATE?>/images/custom/media02-img-08.jpg" alt="">
					<div class="tt-description">
		...
		<div class="container">
			...
			<div class="js-carousel-brand tt-arrow-center slick-alignment-arrows">
				<a class="tt-brand" href="inventory.html" target="_blank">
					<div class="tt-img">
						<img src='<?=DIR_TEMPLATE?>/images/custom/brand_img01.png' alt="">
					</div>
					<h6 class="tt-title">KOA (7)</h6>
				</a>
				<a class="tt-brand" href="inventory.html" target="_blank">
					<div class="tt-img">
						<img src='<?=DIR_TEMPLATE?>/images/custom/brand_img02.png' alt="">
					</div>
					<h6 class="tt-title">Levro (10)</h6>
				</a>
				<a class="tt-brand" href="inventory.html" target="_blank">
					<div class="tt-img">
						<img src='<?=DIR_TEMPLATE?>/images/custom/brand_img03.png' alt="">
					</div>
					<h6 class="tt-title">Porserg (25)</h6>
				</a>
				<a class="tt-brand" href="inventory.html" target="_blank">
					<div class="tt-img">
						<img src='<?=DIR_TEMPLATE?>/images/custom/brand_img04.png' alt="">
					</div>
					<h6 class="tt-title">Seretta (13)</h6>
				</a>
				<a class="tt-brand" href="inventory.html" target="_blank">
					<div class="tt-img">
						<img src='<?=DIR_TEMPLATE?>/images/custom/brand_img05.png' alt="">
					</div>
					<h6 class="tt-title">Dossan (21)</h6>
				</a>
				<a class="tt-brand" href="inventory.html" target="_blank">
					<div class="tt-img">
						<img src='<?=DIR_TEMPLATE?>/images/custom/brand_img06.png' alt="">
					</div>
					<h6 class="tt-title">Noex (5)</h6>
				</a>
				<a class="tt-brand" href="inventory.html" target="_blank">
					<div class="tt-img">
						<img src='<?=DIR_TEMPLATE?>/images/custom/brand_img07.png' alt="">
					</div>
					<h6 class="tt-title">Winger (17)</h6>
				</a>
				<a class="tt-brand" href="inventory.html" target="_blank">
					<div class="tt-img">
						<img src='<?=DIR_TEMPLATE?>/images/custom/brand_img08.png' alt="">
					</div>
					<h6 class="tt-title">WMB (6)</h6>
				</a>
				<a class="tt-brand" href="inventory.html" target="_blank">
					<div class="tt-img">
						<img src='<?=DIR_TEMPLATE?>/images/custom/brand_img09.png' alt="">
					</div>
					<h6 class="tt-title">Jeex (6)</h6>
				</a>
				<a class="tt-brand" href="inventory.html" target="_blank">
					<div class="tt-img">
						<img src='<?=DIR_TEMPLATE?>/images/custom/brand_img10.png' alt="">
					</div>
	...
	<div class="container-indent">
		<div class="tt-promo-02" data-bg="<?=DIR_TEMPLATE?>/images/custom/box-parallax02.jpg">
			<div class="container">
				<div class="tt-block-title">
				...
				<div class="tt-portfolio-content layout-default">
					<div class="element-item sort-value-02">
						<a class="tt-portfolio-item" href="inventory-item02.html">
							<figure>
								<img src="<?=DIR_TEMPLATE?>/images/gallery/gallery_img01.jpg" alt="">
								<figcaption>
					...
					<div class="element-item sort-value-02">
						<a class="tt-portfolio-item" href="inventory-item02.html">
							<figure>
								<img src="<?=DIR_TEMPLATE?>/images/gallery/gallery_img02.jpg" alt="">
								<figcaption>
					...
					<div class="element-item sort-value-01">
						<a class="tt-portfolio-item" href="inventory-item02.html">
							<figure>
								<img src="<?=DIR_TEMPLATE?>/images/gallery/gallery_img03.jpg" alt="">
								<figcaption>
					...
					<div class="element-item sort-value-03">
						<a class="tt-portfolio-item" href="inventory-item02.html">
							<figure>
								<img src="<?=DIR_TEMPLATE?>/images/gallery/gallery_img04.jpg" alt="">
								<figcaption>
					...
					<div class="element-item element-item-2x sort-value-01">
						<a class="tt-portfolio-item" href="inventory-item02.html">
							<figure>
								<img src="<?=DIR_TEMPLATE?>/images/gallery/gallery_img09.jpg" alt="">
								<figcaption>
					...
					<div class="element-item sort-value-02">
						<a class="tt-portfolio-item" href="inventory-item02.html">
							<figure>
								<img src="<?=DIR_TEMPLATE?>/images/gallery/gallery_img05.jpg" alt="">
								<figcaption>
					...
					<div class="element-item sort-value-02">
						<a class="tt-portfolio-item" href="inventory-item02.html">
							<figure>
								<img src="<?=DIR_TEMPLATE?>/images/gallery/gallery_img06.jpg" alt="">
								<figcaption>
					...
					<div class="element-item sort-value-03">
						<a class="tt-portfolio-item" href="inventory-item02.html">
							<figure>
								<img src="<?=DIR_TEMPLATE?>/images/gallery/gallery_img07.jpg" alt="">
								<figcaption>
					...
					<div class="element-item sort-value-01">
						<a class="tt-portfolio-item" href="inventory-item02.html">
							<figure>
								<img src="<?=DIR_TEMPLATE?>/images/gallery/gallery_img08.jpg" alt="">
								<figcaption>
	...
	<div class="container-indent no-margin">
		<div class="tt-promo-01" data-bg="<?=DIR_TEMPLATE?>/images/custom/box-promo01.jpg">
			<div class="container">
				<div class="tt-block-title">
			...
			<div class="js-carousel-news tt-media-carousel tt-arrow-center slick-alignment-arrows dots-error content-error">
				<div>
					<a href="blog-right-column.html" class="tt-media">
						<div class="tt-img">
							<img src="<?=DIR_TEMPLATE?>/images/custom/img_01.jpg" alt="">
						</div>
						<div class="tt-layot">
							<div class="tt-time">
								<span>16</span>
				...
				<div>
					<a href="blog-right-column.html" class="tt-media">
						<div class="tt-img">
							<img src="<?=DIR_TEMPLATE?>/images/custom/img_02.jpg" alt="">
						</div>
						<div class="tt-layot">
							<div class="tt-time">
								<span>18</span>
				...
				<div>
					<a href="blog-right-column.html" class="tt-media">
						<div class="tt-img">
							<img src="<?=DIR_TEMPLATE?>/images/custom/img_03.jpg" alt="">
						</div>
						<div class="tt-layot">
							<div class="tt-time">
								<span>25</span>
				...
				<div>
					<a href="blog-right-column.html" class="tt-media">
						<div class="tt-img">
							<img src="<?=DIR_TEMPLATE?>/images/custom/img_06.jpg" alt="">
						</div>
						<div class="tt-layot">
							<div class="tt-time">
								<span>16</span>
	...
	<div class="container-indent">
		<div class="box-reviews">
			...
			<div class="box-reviews-img">
				<div class="slide-img01 tt-show"><img src="<?=DIR_TEMPLATE?>/images/custom/parallax01-img01.png" alt=""></div>
				<div class="slide-img02"><img src="<?=DIR_TEMPLATE?>/images/custom/parallax01-img02.png" alt=""></div>
				<div class="slide-img03"><img src="<?=DIR_TEMPLATE?>/images/custom/parallax01-img03.png" alt=""></div>
			</div>
		</div>
	</div>
	<div class="container-indent">
...
<footer id="tt-footer">
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col col-auto">
					<a class="tt-logo" href="index-2.html">
						<img class="tt-logo-dark svg-img" src="<?=DIR_TEMPLATE?>/images/logo.svg" alt="">
					</a>
				</div>
			</div>
	...
	<div class="tt-footer-copyright">
		<div class="container">
			<span>&copy; Copyright 2018 Car Leader</span> <a href="#">PRIVACY POLICY</a>
		</div>
	</div>
</footer>
			...
			<div class="modal-body modal-layout-dafault">
				...
				<form class="tt-form-default02">
					...
					<div class="tt-row-radio">
						...
						<div>
							<label class="radio">
								<input id="radio11" checked="" type="radio" name="radio1">
						...
						<div>
							<label class="radio">
								<input id="radio13" type="radio" name="radio1">
					...
					<div class="tt-row-radio">
						...
						<div>
							<label class="radio">
								<input id="radio21" checked="" type="radio" name="radio2">
								<span class="outer"><span class="inner"></span></span>CLEAN
							</label>
						</div>
						<div>
						...
						<div>
							<label class="radio">
								<input id="radio23" type="radio" name="radio2">
								<span class="outer"><span class="inner"></span></span>ROUGH
							</label>
						</div>
					</div>
					<div class="tt-row-radio">
						...
						<div>
							<label class="radio">
								<input id="radio31" checked="" type="radio" name="radio3">
								<span class="outer"><span class="inner"></span></span>NO
							</label>
						</div>
						<div>
							<label class="radio">
								<input id="radio32" type="radio" name="radio3">
	...
	<div class="slide-content">
		<div class="slide-title">
			...
			<div class="col-item">
				...
				<div class="img-obj"><img src="<?=DIR_TEMPLATE?>/images/product_02/product_02_img_02.jpg" alt=""></div>
				<ul>
			...
			<div class="col-item">
				<a href="#" class="item-close"><i class="icon-close"></i></a>
				<div class="img-obj"><img src="<?=DIR_TEMPLATE?>/images/product_02/product_02_img_03.jpg" alt=""></div>
				<ul>
			...
			<div class="col-item">
				<a href="#" class="item-close"><i class="icon-close"></i></a>
				<div class="img-obj"><img src="<?=DIR_TEMPLATE?>/images/product_02/product_02_img_06.jpg" alt=""></div>
				<ul>
...
<script src="<?=DIR_TEMPLATE?>/external/jquery/jquery.min.js"></script>
<script src="<?=DIR_TEMPLATE?>/external/bootstrap/js/bootstrap.min.js"></script>
<script src="<?=DIR_TEMPLATE?>/external/imagesloaded/imagesloaded.pkgd.min.js"></script>
<script src="<?=DIR_TEMPLATE?>/external/slick/slick.min.js"></script>
<script src="<?=DIR_TEMPLATE?>/external/panelmenu/panelmenu.js"></script>
<script src="<?=DIR_TEMPLATE?>/external/isotope/imagesloaded.js"></script>
<script src="<?=DIR_TEMPLATE?>/external/isotope/isotope.pkgd.min.js"></script>
<script src="<?=DIR_TEMPLATE?>/external/sumoselect/jquery.sumoselect.min.js"></script>
<script src="<?=DIR_TEMPLATE?>/external/countdown/jquery.countto.js"></script>
<script src="<?=DIR_TEMPLATE?>/external/perfect-scrollbar/perfect-scrollbar.min.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?sensor=false"></script>
<script src="<?=DIR_TEMPLATE?>/js/main.js"></script>
<!-- form validation and sending to mail -->
<script src="<?=DIR_TEMPLATE?>/external/form/jquery.form.js"></script>
<script src="<?=DIR_TEMPLATE?>/external/form/jquery.validate.min.js"></script>
<script src="<?=DIR_TEMPLATE?>/external/form/jquery.form-init.js"></script>
</body>
