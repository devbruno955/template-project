...
<div style="opacity: 1; visibility: visible;text-align:center;" id="login-wrapper" class="login-whisp">
	...
	<div><a  target="_blank" href="http://www.vipcomsites.com.br/planos-de-marketing"><img src="http://vipcomsistemas.com.br/imagens/banneranimado.gif"></a></div>
                    ...
                    <div id="forms">
                        ...
                        <form id="login_form" action="loginpos.php" method="post" target="_top">
                            ...
                            <div class="input-field-login icon username-container">
                                <input name="username" id="username" autofocus="autofocus" value="teste" placeholder="Digite seu nome de usuário." class="std_textbox" tabindex="1" required="" type="text">
                            </div>
                            <div style="margin-top:30px;" class="input-req-login"><label for="pass">Senha</label></div>
                            <div class="input-field-login icon password-container">
                                <input name="password" id="password" placeholder="Digite a senha" value="12345" class="std_textbox" tabindex="2" required="" type="password" onkeypress="CheckEnter_admin(event);">
                            </div>
                            <div style="width: 285px;">
                                <div class="login-btn">
                                    <button name="login" onclick="javascript:entrar();" type="button" id="login_submit" tabindex="3">Entrar</button>
									<div class="divsenha" style="float: right; margin-left:32px;"> Os dados de acesso são ( usuario: teste e senha: 12345 )</div>
                                </div>
        ...
        <div style="display: block;" id="locale-footer">
            <div class="locale-container">
                ...
                <ul id="locales_list">
                        ...
                        <li><a target="_blank" href="http://www.vipcomsites.com.br/planos-de-email-marketing">Planos de Email Marketing</a></li>
