...
// Check post_max_size (http://us3.php.net/manual/en/features.file-upload.php#73762)
	...
	$pathimages = "superbackground";
	$save_path = dirname(dirname(dirname(dirname(__FILE__)))) . "/media/".$pathimages."/";
  
	if($_POST["tipo"]=="slideshowbanners"  or  $_POST["tipo"]=="slideshowbannersheader" ){
		$save_path = dirname(dirname(dirname(dirname(__FILE__)))) . "/media/".$_POST["tipo"]."/";				// The path were we will save the file (getcwd() may not be reliable and should be tested in your environment)
	}
