<head>
	...
	<link rel="stylesheet" href="<?=$ROOTPATH?>/js/datapiker/jquery-ui.css" type="text/css" media="all">  
	<script type="text/javascript" src="<?=$ROOTPATH?>/js/datapiker/jquery-ui.min.js"></script>
	<script type="text/javascript" src="<?php echo $INI['system']['wwwprefix']; ?>/mobile/js/FormSearch.js"></script>	
