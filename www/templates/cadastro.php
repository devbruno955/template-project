...
<h1 style="font-family: 'Arial'; border-bottom: solid 1px #cccccc; padding: 5px 0px 5px 0px; margin: 0px; color: #0099ff; font-size: 16px; font-weight: bold; letter-spacing: -1px;" name="tid" description="darkColor">Obrigado por se cadastrar em nosso portal</h1>
 <div class="titulo" style="background:#0173C9; box-shadow: 2px 2px 4px 0 #888888;font-family: georgia;font-size: 24px; height: 28px; padding: 0px 12px 0;color:#FFF;margin-bottom:16px;"><?php echo "Pense Imóveis Pense Imópolis"; ?></div> 
 
 
<br> 

<p><?php echo "É com muita satisfação que recebemos seu Cadastro no melhor portal de classificados de Imóveis do Brasil <br>
<br>
Nosso objetivo é sempre lhe oferecer as melhores condições de busca e divulgação de anúncios de Imóveis em nosso ambiente virtual moderno e dinâmico."; ?></p>
<p>  <?php echo "O portal Imópolis é uma ferramenta eficiente para você anunciar e buscar Imóveis em todo o Brasil.
<br><br>
<br><br>
Muito obrigado!"; ?> </a></p>
