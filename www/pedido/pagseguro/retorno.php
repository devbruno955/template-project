...
/*++++++++++++++++++++++++++++++++++++++++++++++++ CRIAÇÃO DO ARRAY DOS DADOS DO PAGAMENTO DO GATEWAY*/
 ...
 $dados_pagamento = array(
    ...
    "idPedido" => $_POST['ProdID_1'] , // idanuncio
...
if ($RetornoPagamento->id_anuncio and $_POST) {

	Util::log($RetornoPagamento->id_anuncio." - ".$RetornoPagamento->status_transacao);

	Util::log($RetornoPagamento->id_anuncio." - Iniciando verificacao do token: ".TOKEN); 
	...
	if ($result == "VERIFICADO") {
		...
		Util::log($RetornoPagamento->id_anuncio." - Token nao verificado. Por favor, renove o seu token no pagseguro: ".TOKEN); 
	}
} 
