            ...
            <div class="box-content">
                ...
                <div class="sect" style="clear:both;" >
                   <table id="orders-list" cellspacing="0" cellpadding="0" border="0" class="coupons-table">
					...
					<tr style="background:#90C6F3;display:none;">
...
function enviar( ){
  ...
  $.get("<?=$INI['system']['wwwprefix']?>/ajax/manage.php?idmodelo="+idmodelo+"&assunto="+assunto+"&action=enviaemailuser&chave=<?=$emails?>&recp=<?=$contadoremails?>",
