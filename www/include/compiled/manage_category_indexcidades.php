    ...
    <div id="content" class="coupons-box clear mainwide">
		<div class="box clear"> 
			...
			<div class="option_box">
				 <div class="top-heading group"> <div class="left_float"><h4>Cidades</h4></div> 
					...
					<div class="paginacaotop"><?php echo $pagestring; ?></div>
					 <div class="sect" style="clear:both;">
						...
						<th width="220">  
							<button type="submit" style="width: 60px;"><span>Buscar</span></button>
							<button type="button" onclick="resetFilter()" style="width: 60px"><span>Limpar</span></button>
						</th>
						 </tr>
						...
						<tr <?php echo $index%2?'':'class="alt"'; ?>>
							...
							<td style="color:<?php echo $color; ?>">	<?php echo $destaque; ?>	</td>
							...
							<td class="op">
							 ...
							 <a href="/vipmin/category/editcidades.php?&id=<?php echo $one['id']; ?>"><img alt="Editar" title="Editar" src="/media/css/i/editar.png" style="width: 22px;">
							  ...
							  <a href="/ajax/manage.php?&action=deletecidade&id=<?php echo $one['id']; ?>" class="ajaxlink" ask="Você tem certeza que deseja apagar este anúncio?"><img alt="Excluir" title="Excluir" src="/media/css/i/excluir.png" style="width: 22px;">
							 </div>
						    </td>
							<?}  ?>
						</tr>
