            ...
            <div class="box-content">
			 <div class="option_box">
					...
					<div class="sect" style="clear:both;">
						...
						<? if(file_exists(WWW_MOD."/pacotes.inc") ){?><th width="150">Qtde de Anúncios</th><? } ?>
						<? if(file_exists(WWW_MOD."/pacotes.inc") ){?><th width="150">Anúncios em Destaque</th><? } ?>
						...
						<tr <?php echo $index%2?'':'class="alt"'; ?> id="order-list-id-<?php echo $one['id']; ?>">
							...
							<? if(file_exists(WWW_MOD."/pacotes.inc") ){?><td><?php echo $one['qtdeanuncio']; ?></td><? } ?>
							<? if(file_exists(WWW_MOD."/pacotes.inc") ){?><td><?php if($one['ehdestaque']=="Y"){ echo "Sim"; } else { echo "Não"; } ?></td><? } ?>
