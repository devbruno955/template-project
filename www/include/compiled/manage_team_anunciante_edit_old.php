        ...
        <div class="clear box"> 
            <div class="box-content">
						...
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group">
								...
								<div class="starts col-md-6 col-xs-12 col-sm-12">
									<div id="c_categoria">
									<div class="report-head">Código de referência: <span class="cpanel-date-hint"></span>&nbsp;<img class="tTip" title="Crie um código de referência para este imóvel." style="cursor:help" id="Search_ToolTip" src="<?=$ROOTPATH?>/media/css/i/info.png"></div>
									<div class="group">
								...
								<div class="ends col-md-6 col-xs-12 col-sm-12"> 
									...
									<div class="report-head">Área total (m²): <span class="cpanel-date-hint"></span>&nbsp;<img class="tTip" title="Informe a área total do imóvel." style="cursor:help" id="Search_ToolTip" src="<?=$ROOTPATH?>/media/css/i/info.png"></div>
									<div class="group">
									...
									<div class="report-head">Área privativa (m²): <span class="cpanel-date-hint"></span>&nbsp;<img class="tTip" title="Informe a área privativa do imóvel." style="cursor:help" id="Search_ToolTip" src="<?=$ROOTPATH?>/media/css/i/info.png"></div>
									<div class="group">
									...
									<div class="report-head">Suíte: <span class="cpanel-date-hint"></span>&nbsp;<img class="tTip" title="Informe o número de suítes caso o imóvel possua." style="cursor:help" id="Search_ToolTip" src="<?=$ROOTPATH?>/media/css/i/info.png"></div>
									<div class="group">
										<input type="text" class="form-control ckeditor"   id="imob_suite" name="imob_suite" value="<?php echo $team['imob_suite']; ?>"> 
									</div>									
									<div class="report-head">Banheiro: <span class="cpanel-date-hint"></span>&nbsp;<img class="tTip" title="Informe o número de banheiros no imóvel." style="cursor:help" id="Search_ToolTip" src="<?=$ROOTPATH?>/media/css/i/info.png"></div>
									<div class="group">
							...
							<div class="form-contain group">
								...
								<div class="starts col-md-6 col-xs-12 col-sm-12">
									...
									<div class="group">
                                        ...
                                        <input type="checkbox" name="adicionais[]" value="QdaTenis" <?php if(in_array("QdaTenis", $addArray)) echo "checked"; ?>> Quadra de Tênnis<br/>
							...
							<div class="form-contain group">
								...
								<div class="starts col-md-6 col-xs-12 col-sm-12">   
									<div id="c_valores">
										...
										<div class="group">
											<input type="text" class="form-control ckeditor"   name="team_price"  id="team_price" class="format_input ckeditor"   value="<?php echo  $team['team_price'] ; ?>"  />    
										</div> 	
								...
								<div class="form-contain group">
									<div class="starts col-md-6 col-xs-12 col-sm-12">   
										<div id="c_valores">
											...
											<div class="group">
												<input type="text" style="border: 1px solid #C1D0D3; color: #666666; width: 95%;" name="video1"  id="video1" class="format_input ckeditor"   value="" /> 
											</div>  
											<?php if($team['video1'] != ""){?>
				...
				<div class="option_box" id="c_estaticas">
					...
					<div class="option_box">
						<div class="top-heading group"> <div class="left_float"><h4>Informações Adicionais</h4> </div> &nbsp;<img class="tTip" title="Escreva abaixo os diferenciais do imóvel. Ex: IPTU pago, Documentação ok, etc.." style="cursor:help" id="Search_ToolTip" src="<?=$ROOTPATH?>/media/css/i/info.png"> </div> 
						<div id="container_box">
							<div id="option_contents" class="option_contents">  
								<div class="form-contain group"> 
									<div class="text_area">  
...
$.get(WEB_ROOT+"/vipmin/delgal.php?id="+idoferta+"&gal="+campo,
   function(data){
      if(jQuery.trim(data)==""){
     	alert("A foto será apagada. Clique no botão SALVAR para efetivar a exclusão desta foto. ");
	  }  
	  else{
		  alert(data)
	  }
	 ...
	 $.get(www+"/include/funcoes.php?acao=finalizaanuncio&partner_id="+idcliente+"&idpedido="+idPedido+"&valor="+Valor+"&idplano="+jQuery('#idplano').val()+"&team_id="+team_id ,
	  function(data){
		  if(jQuery.trim(data)!=""){ 
			...
			$.colorbox({html:"<font color='black' size='2'> Anúncio iniciado com sucesso!</font>"});
