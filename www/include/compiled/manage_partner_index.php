				...
				<div class="option_box">
					 <div class="top-heading group"> <div class="left_float"><h4>Parceiros</h4></div> 
						...
						<div style="padding: 10px;">
							<ul id="log_tools"> <li id="log_switch_referral"><a title="Consultar pedidos pagos com saldo de crédito" href="/vipmin/parceiro/edit.php">Novo Anunciante</a></li> </ul> 
						</div>
					...
					<div class="sect" style="clear:both;">
						...
						<!-- <? if(file_exists(WWW_MOD."/anunciosparceiros.inc")){?> <th width="20">Anúncios <? } ?> -->
						 <th width="20">Tipo</th>
						...
						<? if(file_exists(WWW_MOD."/anunciosparceiros.inc")){ 
