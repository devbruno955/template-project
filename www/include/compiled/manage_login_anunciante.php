<html xmlns="http://www.w3.org/1999/xhtml" id="<?php echo $INI['sn']['sn']; ?>">
	<head>
		...
		<link rel="shortcut icon" href="/skin/padrao/images/favicon.ico" /> 
        ...
        <div id="login-container">
            <div id="login-sub-container">
                <div id="login-sub-header">
					...
					<h2 style="color:#fff;">Anunciante</h2>
                    ...
                    <div id="forms"> 
                        ...
                        <form id="login_form" action="loginpos.php" method="post" target="_top">
                            ...
                            <div class="input-field-login icon username-container">
                                <input name="username" id="username" autofocus="autofocus" value="" placeholder="Digite o mesmo email de cadastro do site" class="std_textbox" tabindex="1" required="" type="text">
                            </div>
                            <div style="margin-top:30px;" class="input-req-login"><label for="pass">Senha</label></div>
                            <div class="input-field-login icon password-container">
                                <input name="password" id="password" placeholder="Digite a mesma senha de cadastro do site" class="std_textbox" tabindex="2" required="" type="password" onkeypress="CheckEnter_admin(event);">
                            </div>
                            <div style="width: 285px;">
                                <div class="login-btn">
                                    <button name="login" onclick="javascript:entrar();" type="button" id="login_submit" tabindex="3">Entrar</button>
									<div class="divsenha" style="float: right; margin-left:32px;"><a class='tk_esquecisenha' href="#">Esqueci� minha senha</a></div>
									<div class="divsenha" style="float: right; margin-left:32px;"><a href="<?php echo $INI['system']['wwwprefix']?>/cadastro">Cadastrar</a></div>
                                </div>
