	...
	<div id="content" class="clear mainwide">
        <div class="clear box"> 
            <div class="box-content">
                <div class="sect">
				<form id="nform" id="nform"  method="post" action="<?php echo $ROOTPATH; ?>/vipmin/team/edit.php?id=<?php echo $team['id']; ?>" enctype="multipart/form-data" class="validator">
						...
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group">
								...
								<div class="starts">
									...
									<div style="clear:both;"class="report-head">Logradouro (Alameda, Avenida, Rodovia, Rua, Travessa, etc.):</div>
									<div class="group">
				...
				<div id="campostipoveiculo"></div>
				 ...
				 <!-- ********************************************* ABA Fotos --> 
				<div class="option_box">
					<div class="top-heading group"> <div class="left_float"><h4>Imagens: Dimensão ideal: 592px (largura) x 502px (altura) -  - <a href="http://pixlr.com/editor/" target="_blank">Clique aqui e reduza o tamanho online</a></h4> </div> </div> 
					<div id="container_box">
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group">
								<!-- =============================   coluna esquerda   =====================================-->
...
function validador(){
	...
	if( jQuery("#team_price").val()==""){
 	 ...
 	 upload_image_bd  = '<?=$team['img0']?>';
	  
	 if( jQuery("#img0").val() =="" & upload_image_bd ==""){
